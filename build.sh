...
$CC $CFLAGS -o ident-portmap ../ident_portmap.c ../ident_portmap_"$uname".c ../buf.c ../util.c
$CC $CFLAGS -o ident-read ../ident_read.c ../buf.c ../util.c
$CC $CFLAGS -o ident-user ../ident_user.c ../buf.c ../util.c
$CC $CFLAGS -o ident-usermap ../ident_usermap.c ../buf.c ../util.c
